...
(function () {
	...
	var testob_basic = function () {

		var testob_basic = function testob_basic(params) {
			...
			if ('attribs' in params) {
				var attrib_names = Object.keys(params.attribs);
		...
		testob_basic.prototype.get = function (attrib_name) {
			...
			if (typeof attrib_name === 'undefined') throw new Error('attrib name is undefined');

			if (this.throw_unknown_attribs && !(attrib_name in this.attribs)) throw new Error('attrib "' + attrib_name + '" unknown');
		...
		testob_basic.prototype.set = function (attrib_name, new_val) {
			...
			if (this.throw_set_undefined && typeof new_val === 'undefined') throw new Error('new value is undefined');

			if (this.attribs[attrib_name] === new_val) return false;
